...
NEWSAPI_CONFIG = {
    'api_key': '7d3d96223d67427f80773dfa3fdf37b8',
...
# Tiingo API Configuration (IEX Cloud Replacement)
TIINGO_CONFIG = {
    'api_key': '8c2e5b1e9d4a1cd31e1bb333d56232ddc382ee46',
    'base_url': 'https://api.tiingo.com/tiingo',
    'timeout': 30,
    'cache_ttl': 60,  # 1 minute for real-time data
    'rate_limit': 1000,  # requests per day (free tier)
    'premium_rate_limit': 10000,  # requests per day (premium tier)
    'supports_realtime': True,
    'supports_historical': True,
    'max_data_points': 10000,
    'endpoints': {
        'daily_prices': '/daily/{ticker}/prices',
        'company_info': '/daily/{ticker}',
        'historical_data': '/daily/{ticker}/prices?startDate={start}&endDate={end}',
        'real_time': '/daily/{ticker}/prices'
    }
}

# Financial Modeling Prep (FMP) Configuration
FMP_CONFIG = {
    'api_key': 'R9F8nfYK9yGdmiq7I5ETw7e6EhTuG8ve',  # Original free key
    ...
    'supports_advanced_financials': False,
    'supports_sec_filings': False,
    'supports_institutional_ownership': False,
    'endpoints': {
        'quote': '/quote/{ticker}',
        ...
        'sec_filings': '/sec-filings/{ticker}',
        'institutional_holders': '/institutional-holder/{ticker}'
    }
}

# FRED API Configuration (Federal Reserve Economic Data)
FRED_CONFIG = {
    'api_key': '9371fbb0a2b505b3262b5578f44016c5',
    'base_url': 'https://api.stlouisfed.org/fred',
    'timeout': 30,
    'cache_ttl': 3600,  # 1 hour for economic data
    'rate_limit': 1200,  # requests per day (free tier)
